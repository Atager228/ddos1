...
def downloadsocks(choice):
	if choice == "4":
		...
		try:
			...
			pass
		try:
			r = requests.get("https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4",timeout=5)
			f.write(r.content)
		except:
			pass
		try:
			r = requests.get("https://api.proxyscrape.com/?request=displayproxies&proxytype=socks4",timeout=5)
			f.write(r.content)
		except:
			pass
		try:
		...
		try:
			...
			pass
		try:
			r = requests.get("https://api.openproxylist.xyz/socks4.txt",timeout=5)
			f.write(r.content)
		except:
			pass
		try:
	...
	if choice == "5":
		...
		try:
			...
			pass
		try:
			r = requests.get("https://api.proxyscrape.com/?request=displayproxies&proxytype=socks5",timeout=5)
			f.write(r.content)
		except:
			pass
		try:
			r = requests.get("https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks5",timeout=5)
			f.write(r.content)
		except:
			pass
		try:
...
def prevent():
	if '.ass' in url :
		print("> You can't attack .ass website!")
		exit()
